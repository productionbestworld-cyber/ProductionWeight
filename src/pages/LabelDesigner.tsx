...
export const DEFAULT_LAYOUT_SHORT: LabelLayout = {
  ...
  fields: [
    ...
    // ── Product (label ซ้าย / ค่าขวา) ──
    { id:'lbl_product', label:'ป้าย Product', sampleValue:'Product',
      x:2, y:14.5, w:22, h:5, fontSize:8.5, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'prodname', label:'ชื่อสินค้า', sampleValue:'LDPE ใส',
      x:24, y:14.5, w:50, h:5, fontSize:9.5, fontWeight:'800', align:'right',
      visible:true, type:'text', border:false, italic:false },

    { id:'lbl_item', label:'ป้าย Item Code', sampleValue:'Item Code',
      x:2, y:19.5, w:22, h:4, fontSize:8, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'itemcode', label:'Item Code', sampleValue:'60001001',
      x:24, y:19.5, w:50, h:4, fontSize:8.5, fontWeight:'800', align:'right',
      visible:true, type:'text', border:false, italic:false },

    { id:'lbl_size', label:'ป้าย Size', sampleValue:'Size',
      x:2, y:23.5, w:22, h:4, fontSize:8, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'size', label:'Size', sampleValue:'120 cm × 40 mc',
      x:24, y:23.5, w:50, h:4, fontSize:8.5, fontWeight:'800', align:'right',
      visible:true, type:'text', border:false, italic:false },

    { id:'lbl_lot', label:'ป้าย Lot No', sampleValue:'Lot No',
      x:2, y:27.5, w:22, h:4, fontSize:8, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'lotno', label:'Lot No', sampleValue:'L240519-01',
      x:24, y:27.5, w:50, h:4, fontSize:8.5, fontWeight:'800', align:'right',
      visible:true, type:'text', border:false, italic:false },

    { id:'lbl_length', label:'ป้าย Length', sampleValue:'Length',
      x:2, y:31.5, w:22, h:4, fontSize:8, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'length', label:'Length / Pcs', sampleValue:'500 M.',
      x:24, y:31.5, w:50, h:4, fontSize:8.5, fontWeight:'800', align:'right',
      visible:true, type:'text', border:false, italic:false },

    { id:'sep2', label:'เส้นคั่น 2', sampleValue:'',
      x:2, y:36, w:72, h:0, fontSize:8, fontWeight:'400', align:'left',
      visible:true, type:'separator', border:false, italic:false },

    // ── เครื่อง / Core ──
    { id:'machine', label:'เครื่อง', sampleValue:'เครื่อง  M-01',
      x:2, y:37, w:36, h:4, fontSize:8, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'core', label:'Core Weight', sampleValue:'Core  1.50 Kg',
      x:38, y:37, w:36, h:4, fontSize:8, fontWeight:'700', align:'right',
      visible:true, type:'text', border:false, italic:false },

    { id:'sep3', label:'เส้นคั่น 3', sampleValue:'',
      x:2, y:41.5, w:72, h:0, fontSize:8, fontWeight:'400', align:'left',
      visible:true, type:'separator', border:false, italic:false },

    // ── Net Weight (ตัวใหญ่) + Gross + QR ──
    { id:'net', label:'Net Weight', sampleValue:'25.50',
      x:2, y:42.5, w:40, h:12, fontSize:22, fontWeight:'900', align:'left',
      visible:true, type:'weight', border:false, italic:false },
    { id:'gross', label:'Gross Weight', sampleValue:'Gross 27.00 Kgs.',
      x:2, y:55, w:40, h:4, fontSize:8, fontWeight:'700', align:'left',
      visible:true, type:'text', border:false, italic:false },
    { id:'qr', label:'QR Code', sampleValue:'QR',
      x:53, y:43, w:21, h:21, fontSize:7, fontWeight:'400', align:'center',
      visible:true, type:'qr', border:false, italic:false },

    { id:'sep4', label:'เส้นคั่น 4', sampleValue:'',
      x:2, y:65, w:72, h:0, fontSize:8, fontWeight:'400', align:'left',
      visible:true, type:'separator', border:false, italic:false },

    // ── ผู้ตรวจ ──
    { id:'inspector', label:'ผู้ตรวจสอบ', sampleValue:'ผู้ตรวจ: นาย ทดสอบ',
      x:2, y:66.5, w:72, h:5, fontSize:9, fontWeight:'800', align:'left',
      visible:true, type:'text', border:false, italic:false },
  ],
}
